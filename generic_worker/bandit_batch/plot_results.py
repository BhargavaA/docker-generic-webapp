...
def get_time_series_on_grid(grid_times,fresh_data=True):
    if fresh_data:
        boto_conn.download_from_s3('kgjamieson-general-compute/hyperband_data_bandit_batch_round2','bandit_batch')
    local_path = 'bandit_batch/hyperband_data_bandit_batch_round2'
